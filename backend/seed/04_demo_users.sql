-- ============================================================================
-- seed/04_demo_users.sql — 데모 사용자 + PINCH + 좋아요 (LOCAL DEV ONLY)
-- ----------------------------------------------------------------------------
...
-- 그 user_id 로 profile/pinch 을 채우는 예시 스크립트입니다.

-- 예: 사용자 1명 생성 (psql 변수 :uid 에 auth.users.id 를 넣었다고 가정)
-- insert into public.profiles (id, username, email, phone, avatar_char)
-- values (:'uid', '시민의식', 'citizen@pinch.kr', '010-1111-2222', '시');

-- 예: 오늘의 토픽 society-1 에 PINCH 등록
