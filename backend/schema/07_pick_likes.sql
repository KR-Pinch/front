-- ============================================================================
-- 07_pick_likes.sql — PINCH 좋아요 (1인 1회, 자기 PINCH 금지)
-- ============================================================================
...
drop trigger if exists pick_likes_block_self on public.pick_likes;
create trigger pick_likes_block_self
  before insert on public.pick_likes
